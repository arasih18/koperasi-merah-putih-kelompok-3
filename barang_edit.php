            ...
            <form action="barang_proses.php?action=edit" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="harga_beli" class="form-control" min="0" value="<?php echo $barang['harga_beli']; ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-bold">Harga Jual (Rp)</label>
                        <input type="number" name="harga_jual" class="form-control" min="0" value="<?php echo $barang['harga_jual']; ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-bold">Stok</label>
                        <input type="number" name="stok" class="form-control" min="0" value="<?php echo $barang['stok']; ?>" required>
                    </div>
                </div>

                <hr>
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-crimson"><i class="fas fa-save me-1"></i> Update Barang</button>
                </div>
            </form>
        </div>
    </div>
