                            ...
                            while ($row = $query->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="supplier_edit.php?id=<?php echo $row['id_supplier']; ?>"
                                            class="btn btn-sm btn-primary" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="supplier_proses.php?action=hapus&id=<?php echo $row['id_supplier']; ?>"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus data supplier ini? Pastikan supplier ini tidak sedang digunakan pada transaksi pembelian.');"
